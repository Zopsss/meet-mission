...
const {create: registeredParticipantCreate} = require('./schema/registered-participant')
const {create: accountCreate} = require('./schema/account')
const {create: userCreate} = require('./schema/user')
const {create: transactionCreate } = require('./schema/transaction');
...
async function populateDatabase() {
  ...
  // 2. Create Users in the 'user' collection
  const createdUsers = await seedUsers(event_id);
 ...
 */
async function seedUsers(eventId) {
